# Generated by Django 3.2.7 on 2021-11-09 09:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('influencer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.influencer')),
                ('posted', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.content')),
        ...
        migrations.AddField(
            model_name='content',
            name='influencer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.influencer'),
        ),
        migrations.CreateModel(
            name='CmpSavePost',
            fields=[
